...
public interface AuroraMallUserService {
    /**
     * 后台分页
     *
     * @param pageUtil
     * @return
     */
    PageResult getAuroraMallUsersPage(PageQueryUtil pageUtil);
     ...
     * @return
     */
    AuroraMallUserVO updateUserInfo(MallUser mallUser, HttpSession httpSession);
