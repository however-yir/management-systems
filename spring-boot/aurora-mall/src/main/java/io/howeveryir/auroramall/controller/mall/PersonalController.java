...
import io.howeveryir.auroramall.util.MD5Util;
...
public class PersonalController {
    ...
    @Resource
    private AuroraMallUserService auroraMallUserService;
    ...
    public String addressesPage(HttpServletRequest request) {
        request.setAttribute("path", "addresses");
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        String loginResult = auroraMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        String registerResult = auroraMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        AuroraMallUserVO mallUserTemp = auroraMallUserService.updateUserInfo(mallUser, httpSession);
