...
import io.howeveryir.auroramall.dao.CarouselMapper;
...
@Service
public class AuroraMallCarouselServiceImpl implements AuroraMallCarouselService {
    ...
    @Override
    public List<AuroraMallIndexCarouselVO> getCarouselsForIndex(int number) {
        List<AuroraMallIndexCarouselVO> auroraMallIndexCarouselVOS = new ArrayList<>(number);
        List<Carousel> carousels = carouselMapper.findCarouselsByNum(number);
        if (!CollectionUtils.isEmpty(carousels)) {
            auroraMallIndexCarouselVOS = BeanUtil.copyList(carousels, AuroraMallIndexCarouselVO.class);
        }
        return auroraMallIndexCarouselVOS;
    }
}
