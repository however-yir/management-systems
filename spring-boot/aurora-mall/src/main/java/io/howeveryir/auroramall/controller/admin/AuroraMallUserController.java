...
public class AuroraMallUserController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(auroraMallUserService.getAuroraMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (auroraMallUserService.lockUsers(ids, lockStatus)) {
